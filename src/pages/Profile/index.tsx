...
export default function Profile() {
    ...
    return (
        <div className="h-[calc(100vh-18rem)] flex flex-col justify-center items-center w-full px-10 lg:px-40 xl:px-60 2xl:px-96 pt-20">
            <div className="w-full border-2 border-gray-300 rounded-xl">
                <div className="p-5">
                    <h3 className="text-3xl text-gray-600 font-semibold">{isChangePass ? "Cambia tu contraseña" : "Tu perfil"}</h3>
                        ...
                        isChangePass ?
                            <>
                                ...
                                <div className="grid grid-cols-5 gap-4 items-start px-5">
                                    <p className="text-xl text-gray-500 font-semibold col-span-3">Antigua contraseña:</p>
                                ...
                                <div className="grid grid-cols-5 gap-4 items-start px-5">
                                    <p className="text-xl text-gray-500 font-semibold col-span-3">Nueva contraseña:</p>
                                    <div className="flex flex-wrap gap-2 col-span-2">
                                        <Input
                                            id="newPassword"
                                            type="password"
                                ...
                                <div className="grid grid-cols-5 gap-4 items-start px-5">
                                    <p className="text-xl text-gray-500 font-semibold col-span-3">Confirmar contraseña:</p>
                                    <div className="flex flex-wrap gap-2 col-span-2">
                                        <Input
                                            id="confirmPassword"
                                            type="password"
                            ...
                            <>
                                <div className="grid grid-cols-5 gap-4 items-center px-5">
                                    <p className="text-xl text-gray-500 font-semibold col-span-2">ID de usuario:</p>
                                    <p className="text-xl text-gray-500 col-span-3">{profile?.id.toUpperCase()}</p>
                                </div>
                                <hr className="border-gray-300 my-5" />
                                <div className="grid grid-cols-5 gap-4 items-center px-5">
                                    <p className="text-xl text-gray-500 font-semibold col-span-2">Nombre completo:</p>
                                    <p className="text-xl text-gray-500 col-span-3">{profile?.description.toUpperCase()}</p>
                                </div>
                                <hr className="border-gray-300 my-5" />
                                <div className="grid grid-cols-5 gap-4 items-start px-5">
                                    <p className="text-xl text-gray-500 font-semibold col-span-2">Roles de usuario:</p>
                                    <div className="flex flex-wrap gap-2 col-span-3">
                                        {profile?.roles.map((rol, index) => (
                                            <Tag text={rol} key={index} />
                                        ))}
                                    </div>
                                </div>
                            </>
